...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    <div class="mb-4">
        <a href="{{ route('farmer.profile.edit') }}" class="text-gray-900 hover:underline font-normal text-md">
            ← Back to Profile
        </a>
    </div>
                            ...
                            @forelse($farmer->crops as $crop)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('farmer.crops.show', $crop) }}" class="text-blue-600 hover:text-blue-900 inline-block" title="View">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-6 py-4 text-center text-gray-500">
                                        ...
                                        <a href="{{ route('farmer.crops.create') }}" class="text-blue-600 hover:text-blue-900">Add the first crop</a>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
