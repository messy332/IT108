...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    <div class="mb-4">
        <a href="{{ route('farmer.crops.index') }}" class="text-gray-900 hover:underline font-normal text-md">
            ← Back to Crops
        </a>
    </div>
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-3">
            ...
            <a href="{{ route('farmer.crops.edit', $crop) }}" 
            class=" text-clack px-4 py-2 font-medium hover:underline">
                Edit Crop
            </a>
            <a href="{{ route('farmer.progress-logs.create') }}?crop_id={{ $crop->id }}" 
                class=" text-clack px-4 py-2 font-medium hover:underline">
                Add Progress Log
            </a>
        </div>
                            ...
                            @forelse($crop->progressLogs as $log)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('farmer.progress-logs.show', $log) }}" class="text-blue-600 hover:text-blue-900 inline-block" title="View">
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-6 py-4 text-center text-gray-500">
                                        ...
                                        <a href="{{ route('farmer.progress-logs.create') }}?crop_id={{ $crop->id }}" class="text-purple-600 hover:text-purple-900">Add the first log</a>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
