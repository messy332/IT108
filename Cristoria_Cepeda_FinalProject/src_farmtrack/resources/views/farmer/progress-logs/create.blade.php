...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('farmer.progress-logs.store') }}" method="POST" id="progressLogForm" novalidate>
            @csrf
            <div class="mb-6 flex justify-center">
                <h1 class="text-3xl font-bold text-gray-900">PROGRESS LOG</h1>
            </div>
            ...
            <div class="flex justify-end space-x-4 mt-8">
                <a href="{{ route('farmer.progress-logs.index') }}" 
